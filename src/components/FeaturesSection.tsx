  ...
  const questions = [
    {
      ...
      answer:
        'Veja como o Votus rastreia e explica o orçamento municipal de forma clara e acessível.',
    },
    {
      ...
      textColor: 'text-white',
      answer:
        'Descubra como os propostas de seus senadores impactam sua vida através do Votus.',
    },
    {
      ...
      textColor: 'text-white',
      answer:
        'Entenda as responsabilidades e poder de ação de governadores de forma didática.',
    },
    {
      ...
      textColor: 'text-white',
      answer:
        'Explore políticas de desenvolvimento rural e oportunidades para o setor agrícola.',
    },
  ];
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        {/* Desktop - Primeira linha */}
        <div className="hidden md:grid md:grid-cols-2 gap-6 mb-8">
          {questions.slice(0, 2).map((q, index) => (
            <div
              key={index}
              className={`${q.color} ${q.textColor} p-8 rounded-lg cursor-pointer hover:shadow-lg transition-all group min-h-40`}
            ...
            >
              <div className="flex items-start min-h-[120px]">
                ...
                <div className="flex-1 min-w-0 pl-2">
                  ...
                  {/* PERGUNTA - permanece visível */}
                  <h3 className="text-2xl font-bold leading-tight">
                    {q.title}
                  </h3>

                  {/* RESPOSTA - aparece no hover */}
                  <div
                  ...
                  >
                    <p className="text-sm opacity-90 leading-relaxed border-t border-white/30 pt-3">
                      {q.answer}
                    </p>
                  </div>
          ...
          {questions.slice(2).map((q, index) => {
            ...
            return (
              <div
                key={cardIndex}
                className={`${q.color} ${q.textColor} p-8 rounded-lg cursor-pointer hover:shadow-lg transition-all group min-h-40`}
                onMouseEnter={() => setExpandedCard(cardIndex)}
                onMouseLeave={() => setExpandedCard(null)}
              >
                <div className="flex items-start min-h-[120px]">
          ...
          {questions.map((q, index) => (
            ...
            >
              ...
              <div className="pl-16">
                ...
                {expandedCard === index && (
                  <p
                    className={`text-sm opacity-80 mt-3 border-t ${
                      q.textColor === 'text-white'
                        ? 'border-white/30'
                        : 'border-ink/30'
                    } pt-3`}
                  >
